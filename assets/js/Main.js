...
},{"/home/matt/Projects/ql-ui/output/DOM.File/index.js":26,"Prelude":62}],28:[function(require,module,exports){
module.exports=require(26)
},{"/home/matt/Projects/ql-ui/output/DOM.File/index.js":26,"Prelude":62}],29:[function(require,module,exports){
// Generated by psc-make version 0.6.9.5
"use strict";
var Prelude = require("Prelude");
var Data_Maybe = require("Data.Maybe");
...
module.exports=require(26)
},{"/home/matt/Projects/ql-ui/output/DOM.File/index.js":26,"Prelude":62}],31:[function(require,module,exports){
// Generated by psc-make version 0.6.9.5
"use strict";
var Prelude = require("Prelude");
var Control_Alt = require("Control.Alt");
...
var isForeignUser = new Data_Foreign_Class.IsForeign(function (value) {
    return Prelude["<$>"](Data_Either.functorEither)(User)(Prelude["<*>"](Data_Either.applyEither)(Prelude["<$>"](Data_Either.functorEither)(function (_1) {
        return function (_2) {
            return {
                name: _1, 
                email: _2
...
var ajax = function (__dict_IsForeign_0) {
    return function (aff) {
        var aff1 = Prelude[">>="](Control_Monad_Aff.bindAff)(aff)(function (_47) {
            if (Prelude[">="](Data_Int.ordInt)(_47.status)(Data_Int.fromNumber(200)) && Prelude["<"](Data_Int.ordInt)(_47.status)(Data_Int.fromNumber(300))) {
                return Prelude["return"](Control_Monad_Aff.monadAff)(_47.response);
            };
        ...
        return Thermite_Action.async(function (k) {
            return Control_Monad_Aff.runAff(function (_414) {
    ...
    return function (_419) {
        return function (_420) {
            return function (_421) {
                if (_419 instanceof HelloWorld) {
                    return Thermite_Html_Elements.h1(Thermite_Events.onClick(ctx)(function (_415) {
                        return Change.value;
                    }))([ Thermite_Html.text("Hello world!") ]);
                };
                if (_419 instanceof Friends) {
                    return Thermite_Html_Elements.h1(Thermite_Events.onClick(ctx)(function (_416) {
                        return Change.value;
                    }))([ Thermite_Html.text("Omg frands") ]);
                };
                throw new Error("Failed pattern match");
            };
        };
...
var performAction = function (_417) {
    return function (_418) {
        return toggleState;
    };
};
var initialState = HelloWorld.value;
...
},{"Prelude":62,"Thermite":70,"Thermite.Action":63,"Thermite.Events":64,"Thermite.Html":67,"Thermite.Html.Attributes":65,"Thermite.Html.Elements":66,"Thermite.Types":69,"UI.AJAX":71}],73:[function(require,module,exports){
require('Main').main();
